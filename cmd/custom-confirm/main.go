...
func initialModel(toolNames []string) model {
	var tools []ToolInfo
...
func main() {
	if len(os.Args) < 2 {
		fmt.Println("Usage: custom-confirm <tool1> <tool2> ...")
		os.Exit(1)
	}
